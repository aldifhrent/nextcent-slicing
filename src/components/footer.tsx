  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center px-[276px] py-[32px] bg-[#F5F7FA]">
        <h1 className="text-[#263238] text-[45px] lg:text-[64px] leading-[76px] font-semibold text-center">
      ...
      <div className="flex flex-col lg:flex-row bg-[#263238] w-full h-full px-[165px] py-[64px] space-x-[125px] justify-between items-center">
        <div className="">
          <Image
            src="/footerlogo.svg"
            width={191}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-0 md:gap-x-4 mt-10 items-center">
            <Image
        ...
        <div className="flex flex-col gap-y-12 lg:gap-y-0 lg:flex-row mt-12 md:mt-0 gap-x-[30px]">
          <div>
