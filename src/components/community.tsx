  ...
  return (
    <Wrapper className="mt-[40px]">
      <div className="flex flex-col items-center justify-center">
        <h1 className="text-[#4D4D4D] text-[24px] lg:text-[36px] font-semibold text-center">
          ...
          {CommunityData.map((community) => (
            ...
            >
              <Image
                ...
                height={56}
              />
              <h1 className="text-[18px] lg:text-[28px] text-center font-bold leading-[36px] mt-[16px]">
                {" "}
                {community.title}
              </h1>
              <p className="mt-[8px] text-[12px] lg:text-[18px]">
